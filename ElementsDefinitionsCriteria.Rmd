...
`r listdefs("Stock.Assessment.Performance")`
...
Proposed definitions:
`r listdefs("Fishing.Mortality..F..Status")`

Proposed definitions:
`r listdefs("Stock.Biomass..B..Status")`
...
Proposed definitions:
`r listdefs("Food.Web..Council.Managed.Predators.")`
...
Proposed definitions:
`r listdefs("Food.Web..Council.Managed.Prey.")`
...
Proposed definitions:
`r listdefs("Food.Web..Protected.Species.Prey")`
...
Proposed definitions:
`r listdefs("Ecosystem.Productivity")`  
...
Proposed definitions:
`r listdefs("Population.Diversity")`
...
Proposed definitions:
`r listdefs("Ecological.Diversity")`
...
Proposed definitions:
`r listdefs("Distribution.Shifts")`
...
Proposed definitions:
`r listdefs("Estuarine.and.Nearshore.Coastal.Habitat")`
