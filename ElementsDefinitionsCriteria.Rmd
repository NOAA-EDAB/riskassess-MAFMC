...
Proposed definitions:
`r listdefs("Marine.Recreational.Angler.Days.Trips")`
...
Proposed definitions:
`r listdefs("Commercial.Fishery.Resilience..Revenue.Diversity.")`
...
Proposed definitions:
`r listdefs("Fishery.Resilience..2.")`
...
Proposed definitions:
`r listdefs("Fishery.Resilience..3.")`
...
Proposed definitions:
`r listdefs("Commercial.Fishery.Resilience..Shoreside.Support.")`
...
Proposed definitions:
`r listdefs("Recreational.Fishery.Resilience..Shoreside.Support.")`
...
Proposed definitions:
`r listdefs("Fishery.Resilience..5.")`
...
Proposed definitions:
`r listdefs("Commercial.Fleet.Diversity")`
...
Proposed definitions:
`r listdefs("Recreational.Fleet.Diversity")`
...
Proposed definitions:
`r listdefs("Community.Vulnerability")`
...
Proposed definitions:
`r listdefs("Commercial.Seafood.Production")`
...
Proposed definitions:
`r listdefs("Recreational.Subsistence.Seafood.Production")`
...
Proposed definitions:
`r listdefs("Commercial.Employment")`

## Recreational Employment (left aside)

Proposed definitions:
`r listdefs("Recreational.Employment")`
...
Proposed definitions:
`r listdefs("Fishing.Mortality.Control")`
...
Proposed definitions:
`r listdefs("Technical.Interactions")`
...
Proposed definitions:
`r listdefs("Offshore.Wind..Biological.Ecosystem.")`

### Offshore Wind Fishery Science (new)

Proposed definitions:
`r listdefs("Offshore.Wind..Fishery.Science.")`

### Offshore Energy Exclusive of Wind (new)

Proposed definitions:
`r listdefs("Offshore.Energy..Exclusive.of.Wind.")`

### Aquaculture (new)

Proposed definitions:
`r listdefs("Aquaculture")`
...
Proposed definitions:
`r listdefs("Regulatory.Complexity.and.Stability")`
...
Proposed definitions:
`r listdefs("Essential.Fish.Habitat")`
