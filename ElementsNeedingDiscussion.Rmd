...
Alternative indirect indicators of prey availability could include the fish condition indicators from the State of the Ecosystem report. These would not rely on detailed diet information, instead reflecting the impact of environmental drivers including prey availability on fish growth.
...
This element would be applied at the ecosystem level, and would evaluate risks to OY across all Council managed species due to invasive species interactions and impacts on stock productivity.
