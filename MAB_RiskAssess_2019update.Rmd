...
Many risk rankings are unchanged based on the updated indicators for 2019 and the Council's risk criteria. Below, we highlight the only elements where updated information has changed the perception of risk. In addition, we present new indicators that the Council may wish to consider in further updates to the EAFM risk assessment.
