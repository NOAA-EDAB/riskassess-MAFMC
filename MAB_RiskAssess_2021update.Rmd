...
Preliminary species narratives have been developed by Grace Roskar and Emily Farr (NMFS Office of Habitat Conservation), using information from the entire team that worked on the Habitat Climate Vulnerability Analysis. We include two here so that the Council may provide feedback to improve their utility for management in general and for potentail future inclusion in the EAFM risk assessment. 
...
We seek Council feedback on whether to include commericial engagement and recreational diversity indicators within the EAFM risk assessment, and if so, what risk criteria should be applied to these indicators.
