...
magick::image_read("images/Figure6_GraceSaba_2024.png")
...
ecodata::plot_commercial_div(report = "MidAtlantic", varName = "Permit revenue species diversity") + ecodata::geom_lm(ggplot2::aes(x=Time, y=Value, group = Var))
