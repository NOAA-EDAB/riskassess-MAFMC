...
```{r oswdevstage, fig.cap="Offshore wind energy area development stages (no activity, planning, construction, operational) during different time periods from 2014-2023. The development stages were used as weighting factors assigned to each wind energy area to determine the potential effect on fisheries and habitat distribution (No stage - no effect; Planning stage - some effect; Construction stage - greater effect; Operational - most effect)."}
