...
The criteria evaluate condition status and major prey trends over the most recent 10 years, and using the full time series with a decay factor to emphasize the most recent 10 years, and present to Committee/Council as alternatives in December 2024. 
  ...
  *Risk Level*    *Definition*
  ...
  Low-Moderate    Fish condition moderate, aggregate prey for this species 
                  has stable or increasing trend

  Moderate-High   Fish condition poor, aggregate prey for this species 
...
The commercial fleet count and revenue diversity have less than 30 years in the time series, therefore trend was not assessed. For fleet count a visual trend may be apparent, while for revenue diversity no apparent visual trend exists. With no trend, this element ranks low risk. 
...
At present, criteria are based only on the existing diversity indicator.
