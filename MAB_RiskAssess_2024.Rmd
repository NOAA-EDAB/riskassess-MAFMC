...
The criteria evaluate condition status and major prey trends over the most recent 10 years, and using the full time series with a decay factor to emphasize the most recent 10 years. Both alternatives are presented in December 2024. 
...
```{r commtab}
commsocvul <- read.csv("CSVI-2022/fishdata_2022_CSVI - Robert Murphy - NOAA Federal.csv")
...
The current risk assessment uses 2022 data, modified criteria for fewer indicator categories and a different set of social indicators. Over 54% of commercial fishing dependent communities and 41% of recreational fishing dependent communities had two or more high social vulnerability ratings. This would rank communities moderate-high to high for social vulnerability, depending on sector. In addition, there is evidence that a majority of Mid-Atlantic communities have high to very high climate vulnerability. Therefore, social vulnerability risk is ranked high. 
...
There is a significant long term decrease in both total commercial landings and U.S. seafood landings in the Mid-Atlantic, indicating moderate-high risk. Only one metric, US seafood landings, has a significant recent decrease. 
...
Using the proposed risk criteria, the example for summer flounder would be assigned low-moderate risk. Summer flounder distribution overlaps with the WEA’s but the stock distribution
overlap within the WEA’s has declined (unweighted overlap) and/or is similar (weighted
overlap) during the two time periods. Since the stock/habitat distribution indicator is developed
at the stock level, the same risk level would be assigned the same for both the commercial and
recreational summer flounder sectors.
