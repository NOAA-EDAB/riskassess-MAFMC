...
Newly available time series indicators can be added to evaluate change in climate-related risk to community commercial fishery revenue over time from temperature, ocean acidification, stock status, with overall rankings of sensitivity and vulnerability (Fig. \ref{fig.commvulex}).

```{r commvulex, fig.cap="Overall annual climate vulnerability for Mid-Atlantic communities (points), with US Northeast average vulnerability (blue line)."}
