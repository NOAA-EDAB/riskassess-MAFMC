...
\fancyheadinit{%
   \ifthenelse{\value{page}=1}%
      {\fancyhead[R]{\textsf{\emph{13 February 2023}}}
       \fancyhead[L]{\textsf{\LARGE DRAFT Mid-Atlantic EAFM Risk Assessment: 2023 Update}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{DRAFT Risk Assessment Update 2023}}}
      }
}
