...
##F status
This element is applied at the species level. Fishing mortality (F) rates relative to established reference points from assessments indicate the level of risk to achieving OY. 

```{r riskF, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Risk Level         | Proposed Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
| Low  | F < Fmsy |
...
##B status
This element is applied at the species level. Biomass (B) levels relative to established reference points from assessments indicate the level of risk to achieving OY. 
...
The EOP Committee and Advisors prefer to remove this element from formal assessment until indicators are further developed and or risk interpretation is clarified.
...
```
-->
*This experimental habitat index is still being studied and improved, so no habitat risk rankings can be based on it at this time. This research is ongoing such that rankings may be possible in the near future.* 

#Economic Elements

##Commercial Profits
This element is applied at the ecosystem level. This element addresses the risk of not maximizing fishery value. *Fleet level could be calculated, and fleet definitions were discussed.*
...
<!--
Providing recreational opportunities is a stated goal of optimal fishery management as part of the definition of "benefits to the nation" under MSA. Recreational fishing is important in the Mid-Atlantic region with many coastal communities having high recreational dependence. -->

----

Although there is an overall trend of increasing recreational fishery participation  in terms of number of anglers, the most recent 10 years has shown a striking decline in both recreation indices. 
...
This element is applied at the business level. This element ranks the risk of reduced fishery business resilience due to access to capital. 
...
There is no current indicator available for this risk element. The EOP Committee and Advisors prefer to remove this element from formal assessment until indicators are further developed and or risk interpretation is clarified.

##Fishery Resilience (3)
This element is applied at the business level. This element ranks the risk of reduced fishery business resilience due to insurance availability. 
...
The number of shoreside support companies that include seafood merchant wholesalers, seafood product preparation and packaging, and seafood markets across all Mid-Atlantic states shows a long term decrease. 
...
However, the number of non-employer entities which include seafood preparation and packaging and seafood markets shows both a long term and short term increase.
...
This element is applied at the business level. This element ranks the risk of reduced fishery business resilience due to limited access to emerging markets/opportunities. 

The EOP Committee and Advisors prefer to remove this element from formal assessment because the issues are addressed under both management elements and species distribution shift elements.
...
##Control
This element is applied at the species and sector level. This element addresses the level of management control in terms of catch measurement and monitoring. Adequate management control indicates low risk of not achieving OY, while poor management control indicates higher risk of not achieving OY. Actual catch is compared with the specifies ABC over the most recent five years of fishery history. 
...
##Other Ocean Uses
This element is applied at the species and fleet level. This element addresses the risk of fishery displacement or damage of a fishery resource and/or habitat that supports it as a result of non-fishing activities in the ocean.  
...
##Allocation
This element is applied at the species and sector level. This element addresses the risk of not achieving OY due to spatial mismatch of stocks and management allocations. Indicators for difficulty of allocation include a combination of distribution shifts (see above) and the number of interests (sectors, states, etc.) requiring allocation.
